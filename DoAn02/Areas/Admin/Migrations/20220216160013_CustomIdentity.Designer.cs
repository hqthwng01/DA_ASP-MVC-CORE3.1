...
namespace DoAn02.Migrations
{
    ...
    [Migration("20220216160013_CustomIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoAn02.Areas.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DoAn02.Models.Cart", b =>
                {
                    ...
                    b.HasOne("DoAn02.Areas.Data.ApplicationUser", "User")
                        .WithOne("Carts")
                        .HasForeignKey("DoAn02.Models.Cart", "UserId");
                });
            ...
            modelBuilder.Entity("DoAn02.Models.Invoice", b =>
                {
                    ...
                    b.HasOne("DoAn02.Areas.Data.ApplicationUser", "User")
                        .WithOne("Invoices")
                        .HasForeignKey("DoAn02.Models.Invoice", "UserId");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DoAn02.Areas.Data.ApplicationUser", null)
                        .WithMany()
